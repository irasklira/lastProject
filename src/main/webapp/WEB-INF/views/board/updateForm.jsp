        ...
        <form id="f_writeForm" name="f_writeForm" class="form-horizontal">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>작성자</td>
                    <td class="text-left">
                        <input type="text" name="b_name" id="b_name" class="form-control" value="${update.b_name}" />
                    </td>
                </tr>
                <tr>
                    <td>글제목</td>
                    <td class="text-left">
                        <input type="text" name="b_title" id="b_title" class="form-control" value="${update.b_title}" />
                    </td>
                </tr>
                <tr>
                    <td>글내용</td>
                    <td class="text-left">
                        <textarea name="b_content" id="b_content" class="form-control" rows="8">${update.b_content}</textarea>
                    </td>
                </tr>
                <tr>
                    <td>비밀번호</td>
